 ...
 * @date 12/07/2022
 * 
 * @description	Billing Document Reversal Approve - VF11 QA
 */
package com.lexmark;
...
public class BillingDocumentReversalApprovalVF11 {
	static String x_csrf_token3, Cookies, BillingDocRevReqVF11, WiId;
